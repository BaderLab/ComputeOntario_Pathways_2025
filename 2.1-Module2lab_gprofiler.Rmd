...
In this example, we will upload the Baderlab gene set file that contains multiple database sources. We will filter the gene-set prior to uploading the gene-set file to g:Profiler. This way, it will ensure that 
...
working_dir = file.path(getwd(),"Module2","gprofiler","data")
