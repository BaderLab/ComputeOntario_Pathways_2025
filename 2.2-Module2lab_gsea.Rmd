...
dest_gmt_file = "./Module2/gprofiler/data/Human_GOBP_AllPathways_noPFOCR_no_GO_iea_May_01_2025_symbol.gmt"
```
...
## Change the colour of the bars to a different colour as they are a different phecotype from the Classical set.
```
